...
# How many total Characters are there? ok
...
print("\n")
# print('How many total Characters are there?: ', rpg_collections.aggregate([{$count: "myCount"}])
# items_list = rpg_collections.find({}, {"items":1, "_id":0})
